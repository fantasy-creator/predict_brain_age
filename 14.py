...
with open("/home/zekaiyu/predict_age_data/eid2age.json", "r") as f:
    eid2age = json.load(f)
...
writer = SummaryWriter(log_dir="runs/age_prediction_14")
...
for epoch in range(epochs):
    ...
    if (epoch + 1) % val_interval == 0:
        ...
        if mae < best_metric:
            ...
            torch.save(model.state_dict(), "best_metric_model_14.pth")
...
plt.legend()
plt.tight_layout()
plt.savefig("final_training_loss_curve_14.png")
plt.close()
...
if len(val_mae_values) > 0:
    ...
    plt.legend()
    plt.tight_layout()
    plt.savefig("final_validation_mae_curve_14.png")
    plt.close()
