...
writer = SummaryWriter(log_dir="runs/age_prediction_12")
...
for epoch in range(epochs):
    ...
    if (epoch + 1) % val_interval == 0:
        ...
        if mae < best_metric:
            ...
            torch.save(model.state_dict(), "best_metric_model_12.pth")
...
plt.legend()
plt.tight_layout()
plt.savefig("final_training_loss_curve_12.png")
plt.close()
...
if len(val_mae_values) > 0:
    ...
    plt.legend()
    plt.tight_layout()
    plt.savefig("final_validation_mae_curve_12.png")
    plt.close()
